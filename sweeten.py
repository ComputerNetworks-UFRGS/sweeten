...
featuresMapping, featuresOptions, featuresTargets, featuresTags, partialOutputYaml = aquire_features(inputYaml)
...
logging.info("Appended tags for each service:")
logging.info(featuresTags)
...
toolsMapping, toolsArchs, toolsOptions = map_tools(featuresMapping, featuresOptions, featuresTags)
...
augmentedOutputYaml, outputs = map_templates(toolsMapping, toolsArchs, toolsOptions, featuresTags, featuresTargets)
